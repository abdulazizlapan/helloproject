...
<body>
    <header class="header" data-sticky="true">
        <div class="header__top">
            <div class="ps-container">
                <a class="ps-logo" href="#"><img  height="50px" width="120px" src="{{ asset('assets/data/img/logos.png')}}" alt=""></a>
            </div>
        </div>
    ...
    <header class="header header--mobile" data-sticky="true">
        <div class="navigation--mobile">
            <div class="navigation__center"><a class="ps-logo" href="#">
    ...
    <div class="ps-panel--sidebar" id="menu-mobile">
        ...
        <div class="ps-panel__content">
            <ul class="menu--mobile">
                ...
                <li class="menu-item-has-children has-mega-menu"><a href="#">Product</a>
                    <span class="sub-toggle"></span>
                    <div class="mega-menu">
                        <div class="mega-menu__column">
                            <h4>Wallpaper<span class="sub-toggle"></span></h4>
                            <ul class="mega-menu__list">
                                <li class="current-menu-item "><a href="#">a</a>
                                </li>
                                <li class="current-menu-item "><a href="#">b</a>
                                </li>
                                <li class="current-menu-item "><a href="#">c</a>
                                </li>
                                <li class="current-menu-item "><a href="#">d</a>
                                </li>
                                <li class="current-menu-item "><a href="#">e</a>
                                </li>
                                <li class="current-menu-item "><a href="#">f</a>
                                </li>
                            </ul>
                        </div>
                        <div class="mega-menu__column">
